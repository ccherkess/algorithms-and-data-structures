...
public class TimSort implements Sort {
	...
	public <V extends Comparable<V>> void sort(V[] array) {
		...
		TimSorting(array, (V v1, V v2) -> (v1).compareTo(v2));
	...
	private <V> void TimSorting(Object[] array, Comparator<V> comparator) {
		
		this.comparator = (Comparator<Object>) comparator;
		
		//если длина массива <= минимально возможной длины подмассива - сортируем вставками
	...
	/*
	 * Подсчёт длины минимального подмассива.
	 * 
	 * Пока длина массива меньше MIN_RUN - длина массива сдвигается на 1 в право (деление на 2)
	 * Если во время сдвига был хотя бы один не нулевой бит - добавляем 1 к результату
	 */
